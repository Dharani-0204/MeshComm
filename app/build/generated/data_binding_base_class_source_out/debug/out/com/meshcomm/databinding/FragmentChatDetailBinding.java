...
public final class FragmentChatDetailBinding implements ViewBinding {
  ...
  private FragmentChatDetailBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnMic,
  ...
  public static FragmentChatDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentChatDetailBinding((LinearLayout) rootView, btnMic, btnSend, emptyState,
          etMessage, rvMessages, switchLocation, tvChatTitle, tvUserId);
    }
